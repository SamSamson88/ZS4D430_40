CLASS zcl_40_struct_02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_40_struct_02 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
   ...
   TYPES: BEGIN OF st_person_nested,
    ...
    person-adresse-ort = 'Göttingen'.
    person-adresse-postal_code = 37170.
    person-adresse-street = 'Schlossalle'.
    person-adresse-status = 'x'.
